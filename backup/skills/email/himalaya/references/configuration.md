...
backend.auth.raw = <REDACTED_PUBLIC_BACKUP>
...
message.send.backend.auth.raw = <REDACTED_PUBLIC_BACKUP>
...
```toml
backend.auth.keyring = <REDACTED_PUBLIC_BACKUP>
```
...
```toml
backend.auth.type = <REDACTED_PUBLIC_BACKUP>
backend.auth.client-id = <REDACTED_PUBLIC_BACKUP>
backend.auth.client-secret.cmd = <REDACTED_PUBLIC_BACKUP>
backend.auth.access-token.cmd = <REDACTED_PUBLIC_BACKUP>
backend.auth.refresh-token.cmd = <REDACTED_PUBLIC_BACKUP>
backend.auth.auth-url = <REDACTED_PUBLIC_BACKUP>
backend.auth.token-url = <REDACTED_PUBLIC_BACKUP>
```
