...
TOKEN_PATH = <REDACTED_PUBLIC_BACKUP>
CLIENT_SECRET_PATH = <REDACTED_PUBLIC_BACKUP>
PENDING_AUTH_PATH = <REDACTED_PUBLIC_BACKUP>
...
def exchange_auth_code(code: str):
    ...
    pending_auth = <REDACTED_PUBLIC_BACKUP>
    raw_callback = code
    ...
    token_payload = <REDACTED_PUBLIC_BACKUP>
